...
final class Store: NSObject {
    ...
    var trackersFilter: TrackersFilter = .today
    ...
    func editTracker(trackerCD: TrackerCD, newTracker: Tracker, category: TrackerCategoryCD) throws {
        updateExistingTracker(trackerCD, with: newTracker, category: category)
        try context.save()
    }
