...
final class StatisticsViewController: UIViewController {
    ...
    private let noStatisticsView: UIView = {
        ...
        noTrackersIndicatorLabel.text = NSLocalizedString("nothingToAnalyze",comment: "")
    ...
    override func viewDidLoad() {
        ...
        bestPeriodView.metricDescription = NSLocalizedString("statisticsBestPeriod", comment: "")
        bestDaysView.metricDescription = NSLocalizedString("statisticsBestDays", comment: "")
        averageTrackersCompletedView.metricDescription = NSLocalizedString("statisticsAverage", comment: "")
    ...
    func refreshStatisticsViews(trackersCompleted: Int) {
